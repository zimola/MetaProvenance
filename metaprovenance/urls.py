...
from db.views import (
    ...
    SampleDetail, SampleList, SampleUpdate
)
...
urlpatterns = [
    ...
    re_path(r'db/investigation/all(?P<action>/?\w*)/$', InvestigationList.as_view(), 
    ...
    # Sample Routing
    re_path(r'db/sample/all/$', SampleList.as_view(),
            name = 'sample_all',
            kwargs = {'view_title': 'All Samples', 'allow_anonymous': True}),
    re_path(r'db/sample/(?P<sample_id>\d+)/$', SampleDetail.as_view(),
        name='sample_detail',
        kwargs={'view_title': 'Sample Detail', 'allow_anonymous': True}),
    re_path(r'db/sample/edit/(?P<sample_id>\d+)/$', SampleUpdate.as_view(),
        name='sample_update',
        kwargs={'view_title': 'Sample Update', 'allow_anonymous': False}),

    # Investigation Metadata Routing
    re_path(r'db/investigation/metadata/(?P<investigation_id>\d+)/$', InvestigationMetadataDetail.as_view(),
    ...
    # Protocol Routing
    re_path(r'db/protocol/(?P<protocol_id>\d+)/$', ProtocolDetail.as_view(),
        name='protocol_detail',
        kwargs={'view_title': "Protocol Detail", 'allow_anonymous': True}),
    re_path(r'db/protocol/all/$', ProtocolList.as_view(),
        name='protocol_all',
        kwargs={'view_title': "View All Protocols", 'allow_anonymous': True}),
    re_path(r'db/protocol/create/$', ProtocolCreate.as_view(),
        name = 'protocol_create',
        kwargs={'view_title': "Create New Protocol", 'allow_anonymous': False}),
    re_path(r'db/protocol/edit/(?P<protocol_id>\d+)/$', ProtocolUpdate.as_view(),
        name = 'protocol_update',
        kwargs={'view_title': "Protocol Update", 'allow_anonymous': False}),

    # Protocol Step Routing
    re_path(r'db/protocol/step/all/$', ProtocolStepList.as_view(),
            name='protocol_step_all',
            kwargs={'view_title': "View All Protocol Steps", 'allow_anonymous': True}),
    re_path(r'db/protocol/step/create/$', ProtocolStepCreate.as_view(),
        name = 'protocol_step_create',
        kwargs={'view_title': "Create New Protocol Step", 'allow_anonymous': False}),
    re_path(r'db/protocol/step/(?P<protocol_step_id>\d+)/$', ProtocolStepDetail.as_view(),
        name = 'protocol_step_detail',
        kwargs={'view_title': "Protocol Step Detail", 'allow_anonymous': True}),
    re_path(r'db/protocol/step/edit/(?P<protocol_step_id>\d+)/$', ProtocolStepUpdate.as_view(),
    ...
    re_path(r'db/protocol-step-grid(?P<action>/?\w*)/$', ProtocolStepFkWidgetGrid.as_view(),
